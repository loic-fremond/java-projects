/*******************************************
 * Ce programme simule l'organisation de courses de rallyes auto-moto.
 *
 * Ces rallyes se déroulent sous la forme d'un Grand Prix.
 *
 * Les véhicules pouvant participer à un rallye sont des voitures ou des motos (avec ou sans sidecar).
 * Toutefois, un Grand Prix ne peut avoir lieu qu'avec des véhicules de catégories similaires. Les catégories sont les quatre-roues (voitures, et motos avec sidecar) et les deux-roues (motos sans sidecar).
 *
 * Le main se décompose en quatre parties permettant d'effectuer des tests au fur et à mesure de la programmation.
 *******************************************/
